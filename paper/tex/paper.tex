...
\date{Technical report v2 --- August 12, 2026\\[2pt]\small Measurements executed 11--12 August 2026 unless dated otherwise.\\\small Code, harness, and raw results: \href{https://github.com/mlpal-ai/mlpal-gateway}{\texttt{github.com/mlpal-ai/mlpal-gateway}} (Apache-2.0)}
...
\item MLPal, \texttt{mlpal-gateway} source. \url{github.com/mlpal-ai/mlpal-gateway}.
...
\item MLPal, ``Yodex vs Claude Code on claude-opus-5'' (2026-07-28). \url{github.com/mlpal-ai/yodex}.
