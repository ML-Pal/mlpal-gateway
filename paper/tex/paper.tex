...
\title{\bfseries Curation Over Breadth: Design and Measurement\\of a Self-Hostable, Availability-Aware AI Gateway}
\author{Sai Vivek Peddi\\MLPal \and Claude\\\textit{benchmark harness \& analysis}}
\date{Technical report v2 --- August 12, 2026\\[2pt]\small Measurements executed 11--12 August 2026 unless dated otherwise.\\\small Code, harness, and raw results: \href{https://github.com/mlpalOld/mlpal-gateway}{\texttt{github.com/mlpalOld/mlpal-gateway}} (Apache-2.0)}
...
\subsection{Gateway overhead: full admission, faster than a bare proxy}\label{sec:overhead}
...
\subsection{Same-night four-way comparison, including OpenRouter}\label{sec:openrouter}
...
\item MLPal, \texttt{mlpal-gateway} source. \url{github.com/mlpalOld/mlpal-gateway}.
...
\item MLPal, ``Yodex vs Claude Code on claude-opus-5'' (2026-07-28). \url{github.com/mlpalOld/yodex}.
